  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-red-300 shadow-sm overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* Prompt 12: Alternative Structures */}
        {decision.alternatives && decision.alternatives.length > 0 && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-6">
            ...
            <p className="text-sm text-blue-800 mb-4">
              While we couldn&apos;t approve your current request, you may qualify under one of these alternative structures:
            </p>
            <div className="space-y-3">
              {decision.alternatives.map((alt: any, idx: number) => (
                <div key={idx} className="bg-white rounded-lg p-3 border border-blue-100 shadow-sm flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900 capitalize">
                      {alt.structure_type.replace(/_/g, " ")}
                    </p>
        ...
        <Link
          href="/apply"
          className="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 rounded-xl transition-colors mt-6"
        >
          Review & Reapply
        </Link>
      </div>
