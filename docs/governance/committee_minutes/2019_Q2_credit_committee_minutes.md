        ...
        **Quorum:** Confirmed (7 of 8 voting members present)
        ...
        Minutes from the Q1 2019 meeting were reviewed and approved with no amendments.
        **Vote:** Unanimous.
        ...
        The Chief Credit Officer presented Q2 2019 portfolio performance:

        | Metric | Actual | Prior Quarter | Budget | YoY |
|---|---|---|---|---|
| Approval Rate | 27.0% | — | 28.0% | — |
| 30+ DPD Rate | 18.0% | — | 1.80% | — |
| Net Charge-Off Rate (bps) | 55 bps | — | 50 bps | — |
| Provision Expense | $150.0M | — | — | — |
        ...
        **Item 3.1:** Review of FICO floor parameters for upcoming quarter — no changes proposed. Credit quality remains stable. **Vote:** No action required.
        ...
        |---|---|---|---|---|
        | cc_pd_v1 | 0.808 | 48% | 0.05 | ✓ Stable |
        | pl_pd_v1 | 0.788 | 46% | 0.040 | ✓ Stable |
        | mortgage_pd_v1 | 0.772 | 44% | 0.03 | ✓ Stable |
        ...
        CFPB qualified mortgage patch expiry anticipated 2021. Reviewing credit access impact.
        ...
        |---|---|---|
        | Distribute meeting minutes for review | Credit Ops | 2019-004-15 |
        ...
        **Next Meeting:** End of Q3 2019 (tentative).
