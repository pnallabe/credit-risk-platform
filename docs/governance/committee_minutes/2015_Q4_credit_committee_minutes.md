        ...
        **Quorum:** Confirmed (7 of 8 voting members present)
        ...
        Minutes from the Q3 2015 meeting were reviewed and approved with no amendments.
        **Vote:** Unanimous.
        ...
        The Chief Credit Officer presented Q4 2015 portfolio performance:
...
| Provision Expense | $150.0M | — | — | — |
        ...
        **Item 3.1:** Review of FICO floor parameters for upcoming quarter — no changes proposed. Credit quality remains stable. **Vote:** No action required.
        ...
        |---|---|---|---|---|
        | cc_pd_v1 | 0.820 | 52% | 0.05 | ✓ Stable |
        | pl_pd_v1 | 0.800 | 50% | 0.040 | ✓ Stable |
        | mortgage_pd_v1 | 0.780 | 48% | 0.03 | ✓ Stable |
        ...
        CFPB finalized HMDA data collection expansion rule (Reg C amendments).
        ...
        |---|---|---|
        | Distribute meeting minutes for review | Credit Ops | 2015-10-15 |
        ...
        **Next Meeting:** End of Q1 2016 (tentative).
