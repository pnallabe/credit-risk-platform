        ...
        **Quorum:** Confirmed (7 of 8 voting members present)
        ...
        | Independent Director | Dr. Yuki Tanaka | — (excused) |

        ---

        ## 1. Approval of Prior Minutes

        Minutes from the Q3 2021 meeting were reviewed and approved with no amendments.
        **Vote:** Unanimous.
        ...
        The Chief Credit Officer presented Q4 2021 portfolio performance:

        | Metric | Actual | Prior Quarter | Budget | YoY |
|---|---|---|---|---|
| Approval Rate | 34.0% | — | 28.0% | — |
| 30+ DPD Rate | 12.0% | — | 1.80% | — |
| Net Charge-Off Rate (bps) | 28 bps | — | 50 bps | — |
| Provision Expense | $45.0M | — | — | — |


        **Discussion:** The CRO noted portfolio performance is within expected ranges for the current rate environment. No material adverse trends requiring immediate policy action were identified.

        ---

        ## 3. Policy Change Proposals & Votes

        **Item 3.1:** Review of FICO floor parameters for upcoming quarter — no changes proposed. Credit quality remains stable. **Vote:** No action required.
        **Item 3.1:** Annual rate calibration review. Presented by Chief Credit Officer. **Outcome:** Standard rate schedule maintained. Approved unanimously.
        ...
        |---|---|---|---|---|
        | cc_pd_v1 | 0.802 | 46% | 0.05 | ✓ Stable |
        | pl_pd_v1 | 0.782 | 44% | 0.040 | ✓ Stable |
        | mortgage_pd_v1 | 0.768 | 42% | 0.03 | ✓ Stable |
        ...
        CFPB credit card penalty fee scrutiny. Infrastructure bill — construction loan demand.
        ...
        |---|---|---|
        | Distribute meeting minutes for review | Credit Ops | 2021-10-15 |
        ...
        **Next Meeting:** End of Q1 2022 (tentative).
