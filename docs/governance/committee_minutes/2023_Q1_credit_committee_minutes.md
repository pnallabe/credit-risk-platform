        ...
        ## Q1 2023 Credit Committee Meeting
        ...
        **Quorum:** Confirmed (7 of 8 voting members present)
        ...
        Minutes from the Q4 2022 meeting were reviewed and approved with no amendments.
        **Vote:** Unanimous.
        ...
        The Chief Credit Officer presented Q1 2023 portfolio performance:

        | Metric | Actual | Prior Quarter | Budget | YoY |
|---|---|---|---|---|
| Approval Rate | 24.0% | — | 28.0% | — |
| 30+ DPD Rate | 21.5% | — | 1.80% | — |
| Net Charge-Off Rate (bps) | 74 bps | — | 50 bps | — |
| Provision Expense | $245.0M | — | — | — |
        ...
        **Item 3.1:** Review of FICO floor parameters for upcoming quarter — no changes proposed. Credit quality remains stable. **Vote:** No action required.
        ...
        SVB/Signature Bank failures — liquidity stress monitoring. Basel III comment period ends.
        ...
        |---|---|---|
        | Distribute meeting minutes for review | Credit Ops | 2023-001-15 |
        ...
        **Next Meeting:** End of Q2 2023 (tentative).
